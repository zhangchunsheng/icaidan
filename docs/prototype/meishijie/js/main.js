...
$("#msjtop_loginbtn").bind("click",function(){
	Alert("登录美食杰", "iframe:iframe_login.html", "700", "300", "false", "", "true", "img");
	return false;
});

$("#msjtop_registerbtn").bind("click",function(){
	Alert("注册美食杰", "iframe:iframe_login.html", "700", "300", "false", "", "true", "img");
	return false;
});
...
$("#sccon_left").mouseenter(function(){
	$(this).next().stop().animate({width:"212px"},600,function(){});
